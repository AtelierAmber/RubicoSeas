...
#include "IsogridInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UIsogridInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UIsogridInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UIsogridInteractiveTool* NewTool = NewObject<UIsogridInteractiveTool>(SceneState.ToolManager);
...
UIsogridInteractiveToolProperties::UIsogridInteractiveToolProperties()
{
...
void UIsogridInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UIsogridInteractiveTool::Setup()
{
	...
	Properties = NewObject<UIsogridInteractiveToolProperties>(this, "Measurement");
...
void UIsogridInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UIsogridInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UIsogridInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UIsogridInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UIsogridInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UIsogridInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UIsogridInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UIsogridInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UIsogridInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
