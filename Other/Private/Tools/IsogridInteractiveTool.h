...
#include "IsogridInteractiveTool.generated.h"


/**
 * Builder for UIsogridInteractiveTool
 */
UCLASS()
class ISOGRID_API UIsogridInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UIsogridInteractiveTool
 */
UCLASS(Transient)
class ISOGRID_API UIsogridInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UIsogridInteractiveToolProperties();
...
/**
 * UIsogridInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class ISOGRID_API UIsogridInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UIsogridInteractiveToolProperties> Properties;
