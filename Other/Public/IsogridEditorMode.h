...
#include "IsogridEditorMode.generated.h"
 ...
 */
UCLASS()
class UIsogridEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_IsogridEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UIsogridEditorMode();
	virtual ~UIsogridEditorMode();
